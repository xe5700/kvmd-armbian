...
raw_mirror(){
	...
	while [ $tryagain -eq 1 ]; do
		$capture = 1;
		case $capture in 
		0) url_raw="https:\\/\\/raw.githubusercontent.com\\/";;
		1) url_raw="https:\\/\\/raw.fastgit.org\\/";;
		2) url_raw="https:\\/\\/cdn.staticaly.com\\/gh\\/";;
		3) url_raw="https:\\/\\/ghproxy.com\\/https:\\/\\/raw.githubusercontent.com\\/";;
		*) printf "\nTry again.\n"; tryagain=1;;
		esac
		echo
		echo "Github raw URL -> $url_clone"
		echo
	done
}
